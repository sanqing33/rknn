...
if __name__ == '__main__':
    ...
    # Show the classification results and get the index of the most likely class
    ...
    # 保存标注后的图片，可以根据实际需求调整保存路径和文件名
    cv2.imwrite('space_shuttle_224_labeled.jpg', ori_img)
